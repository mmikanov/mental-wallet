...
- [ ] 1. Data layer and configuration
  - [ ] 1.1 Add new curated library cards ("Name It to Tame It" and "Evening Gratitude")
  ...
  - [ ] 1.2 Create onboarding configuration file (`src/data/onboardingConfig.ts`)
  ...
  - [ ] 1.3 Create the Zustand onboarding store (`src/stores/onboardingStore.ts`)
  ...
  - [ ] 1.4 Create the onboarding service (`src/services/onboardingService.ts`)
  ...
  - [ ]* 1.5 Write property tests for onboarding data layer
...
- [ ] 3. Navigation and onboarding screens
  - [ ] 3.1 Update navigation types (`src/navigation/types.ts`)
    - Replace `Disclaimer: undefined` with `Onboarding: undefined` in `RootStackParamList`
    - _Requirements: 8.1_

  - [ ] 3.2 Create the OnboardingNavigator (`src/navigation/OnboardingNavigator.tsx`)
  ...
  - [ ] 3.3 Create the WelcomeScreen (`src/screens/onboarding/WelcomeScreen.tsx`)
  ...
  - [ ] 3.4 Create the IntentSelectionScreen (`src/screens/onboarding/IntentSelectionScreen.tsx`)
  ...
  - [ ] 3.5 Update RootNavigator (`src/navigation/RootNavigator.tsx`)
  ...
  - [ ]* 3.6 Write property test for state-to-route resolution
...
- [ ] 4. Checkpoint - Ensure navigation and screens work
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Micro-Tutorial system
  - [ ] 5.1 Create the TooltipOverlay component (`src/components/onboarding/TooltipOverlay.tsx`)
  ...
  - [ ] 5.2 Create the useMicroTutorial hook (`src/hooks/useMicroTutorial.ts`)
  ...
  - [ ] 5.3 Create the OnboardingBanner component (`src/components/onboarding/OnboardingBanner.tsx`)
  ...
  - [ ]* 5.4 Write property test for tutorial state machine
...
- [ ] 6. First Action Checklist
  - [ ] 6.1 Create the FirstActionChecklist component (`src/components/onboarding/FirstActionChecklist.tsx`)
  ...
  - [ ] 6.2 Integrate onboarding overlays into WalletScreen (`src/screens/WalletScreen.tsx`)
  ...
  - [ ]* 6.3 Write property tests for checklist auto-marking
...
- [ ] 7. Checkpoint - Ensure micro-tutorial and checklist work
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. State persistence and edge cases
  - [ ] 8.1 Implement onboarding state persistence and resume logic
