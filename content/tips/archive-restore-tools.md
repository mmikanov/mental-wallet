---
title: "Tidy your wallet without losing anything"
summary: "Not using a tool right now? Archive it to clear the clutter. It's tucked safely away with all its history, ready to restore whenever you want it back."
...
month might just be in the way today. Instead of deleting it, you can archive it.

Tap the tool to open it, then tap the **⋮** menu and choose **Archive card**. It leaves your
wallet right away, so what's left is only what you're actually using now. Nothing is lost:
your usage history, streaks, and past entries all stay intact.
