---
title: "Can't find your app? Add it yourself"
summary: "If an app you love isn't in the library, make your own card for it in a minute. Give it a name and a link, and launch it from your wallet like any other tool."
...
you rely on isn't there, you don't have to go without. You can add it yourself.

Open the menu (the ⋮ at the top right of your wallet) and choose **Create Tool**. Give your
card a name and an icon in the first step. In the next step, tap Add block and pick
Link Button. That's the piece that turns your card into a launcher.

Fill in three things: a Label for the button (like "Open my app"), a Target URL, and an
